...
class Grammar
{
    ...
    {
        return $this->compileFields($blueprint->getFields());
    }
     ...
     * @return array
     */
    public function compilePoint(Fluent $fluent): array
    {
        $map = [
            'type'              => 'geo_point',
     ...
     * @return array
     */
    public function compileShape(Fluent $fluent): array
    {
        $map = [
            'type'               => 'geo_shape',
            'tree'               => $fluent->tree,
     ...
     * @return array
     */
    public function compileToken_count(Fluent $fluent): array
    {
        $map = [
            'type'           => 'token_count',
            'boost'          => $fluent->boost,
     ...
     * @return array
     */
    public function compileString(Fluent $fluent): array
    {
        $map = [
            'type'                   => 'string',
            'analyzer'               => $fluent->analyzer,
     ...
     * @return array
     */
    protected function formatMap(array $map): array
    {
     ...
     * @return array
     */
    public function compileFields($fields): array
    {
        $statement = [];
